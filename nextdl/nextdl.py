...
from .utils import (DEFAULT_OUTTMPL, ContentTooShortError, DateRange,
                    ...
                    UnavailableVideoError, age_restricted, args_to_str,
                    ...
                    locked_file, make_HTTPS_handler, nextdlCookieJar,
                    nextdlCookieProcessor, nextdlHandler,
                    nextdlRedirectHandler, orderedSet, parse_filesize,
                    platform_name, preferredencoding, prepend_extension,
    ...
    def _setup_opener(self):
        ...
        def file_open(*args, **kwargs):
            raise compat_urllib_error.URLError(
                "file:// scheme is explicitly disabled in nextdl for security reasons"
            )
