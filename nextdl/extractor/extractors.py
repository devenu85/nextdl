...
from .arte import ArteTVEmbedIE, ArteTVIE, ArteTVPlaylistIE
...
from .bilibili import (BilibiliAudioAlbumIE, BilibiliAudioIE,
                       BiliBiliBangumiIE, BiliBiliIE, BiliBiliPlayerIE)
...
from .francetv import (CultureboxIE, FranceTVEmbedIE, FranceTVIE,
                       FranceTVInfoIE, FranceTVInfoSportIE, FranceTVJeunesseIE,
                       FranceTVSiteIE, GenerationWhatIE)
...
from .pornhub import (PornHubIE, PornHubPagedVideoListIE, PornHubUserIE,
...
from .tvnow import (TVNowAnnualIE, TVNowIE, TVNowNewIE, TVNowSeasonIE,
                    TVNowShowIE)
...
from .youtube import (YoutubeFavouritesIE,  # YoutubeSearchURLIE,
                      YoutubeHistoryIE, YoutubeIE, YoutubePlaylistIE,
                      YoutubeRecommendedIE, YoutubeSearchDateIE,
                      YoutubeSearchIE, YoutubeSubscriptionsIE, YoutubeTabIE,
...
from .zattoo import (BBVTVIE, EWETVIE, SAKTVIE, VTXTVIE, EinsUndEinsTVIE,
                     GlattvisionTVIE, MNetTVIE, MyVisionTVIE, NetPlusIE,
                     OsnatelTVIE, QuantumTVIE, QuicklineIE, QuicklineLiveIE,
                     SaltTVIE, WalyTVIE, ZattooIE, ZattooLiveIE)
