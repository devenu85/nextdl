...
class ProSiebenSat1IE(ProSiebenSat1BaseIE):
    ...
    _TESTS = [
        {
            # Tests changes introduced in https://github.com/nextdl/nextdl/pull/6242
            # in response to fixing https://github.com/nextdl/nextdl/issues/6215:
