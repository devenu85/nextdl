...
class PBSIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        },
        {
            ...
            # https://github.com/nextdl/nextdl/issues/7059)
        ...
        {
            # https://github.com/nextdl/nextdl/issues/13801
    ...
    def _real_extract(self, url):
        ...
        if http_url:
            for m3u8_format in m3u8_formats:
                ...
                # 1. https://github.com/nextdl/nextdl/commit/cbc032c8b70a038a69259378c92b4ba97b42d491#commitcomment-17313656
