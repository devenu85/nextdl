...
from ..utils import (ExtractorError, OnDemandPagedList, clean_html,
                     ...
                     js_to_json, merge_dicts, parse_filesize, parse_iso8601,
                     sanitized_Request, smuggle_url, std_headers, str_or_none,
                     try_get, unescapeHTML, unified_timestamp, unsmuggle_url,
...
class VimeoIE(VimeoBaseInfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if is_pro:
            ...
            # https://github.com/nextdl/nextdl/issues/20070
