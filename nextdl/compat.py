...
try:
    ...
    # is apparently broken (see https://github.com/nextdl/nextdl/pull/6244)
...
# Fix https://github.com/nextdl/nextdl/issues/4223
...
if platform.python_implementation() == "PyPy" and sys.pypy_version_info < (5, 4, 0):
    ...
    # 2. https://github.com/nextdl/nextdl/pull/4392
