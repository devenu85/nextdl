...
from nextdl.compat import (compat_basestring, compat_getpass, compat_print,
                           compat_urllib_request)
from nextdl.utils import make_HTTPS_handler, sanitized_Request


class GitHubReleaser(object):
    _API_URL = "https://api.github.com/repos/nextdl/nextdl/releases"
    _UPLOADS_URL = (
        "https://uploads.github.com/repos/nextdl/nextdl/releases/%s/assets?name=%s"
    )
...
def main():
    ...
    new_release = releaser.create_release(
        version, name="nextdl %s" % version, body=body
    )
