...
from nextdl.compat import (compat_etree_Element, compat_etree_fromstring,
                           compat_expanduser, compat_getenv, compat_setenv,
...
class TestCompat(unittest.TestCase):
    ...
    def test_all_present(self):
        ...
        present_names = set(
            filter(lambda c: "_" in c and not c.startswith("_"), dir(nextdl.compat))
